...
### Ich brauche ein Kochrezpet zur Datenanalyse

FRAGE: Ich brauche ein Kochrezept für die Datenanalyse!


ANTWORT: Die [sieben Schritte der Datenanalyse](https://fopro.netlify.app/080-auswerten#%C3%BCber-sieben-br%C3%BCcken-musst-du-gehen-die-sieben-schritte-der-datenanalyse). Die [Checkliste zur Datenanalyse](https://fopro.netlify.app/080-auswerten#sec-checkdaten) oder der [Rostlöser](https://fopro.netlify.app/080-auswerten#rostl%C3%B6ser) wird Ihnen gute Dienste leisten.
...
Anstatt die Werte 0 und 1 bei der neuen UV_high Spalte zu bekommen, kommen nur Nas raus. Auch mit dem Befehl drop_na hat es nicht geklappt. 
Dies habe ich nicht nur mit dem RStudio auf meinem Computer versucht sondern auch über die Cloud über mein IPad. (Bei beiden Geräten kam es zuvor noch nie zu Problemen) Hier mein R-Code:
