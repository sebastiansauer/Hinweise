...
## Sie sind krank und können nicht zum Unterricht kommen

Bitte beachten Sie,
dass Sie wenn Sie verhindert sind, im Unterricht zu erscheinen, z.B. aufgrund Krankheit,
Sie sich selbständig um die *Nacharbeit* kümmern müssen.
Das bedeutet, dass Sie den Stoff, der in der versäumten Stunde behandelt wurde, *selbständig* nacharbeiten müssen.
Bitte beachten Sie, dass Sie bei Fragen zum Stoff sich an Ihre Kommilitonis wenden können, aber auch an Ihren Dozenten.
Bitte beachten Sie, dass Sie bei Krankheit sich *nicht* an den Dozenten wenden müssen, um sich zu entschuldigen.

Bitte beachten Sie, 
dass für die Krankmeldung bei einer Prüfung besondere Regeln gelten.
Bitte erkundigen Sie sich ggf. beim Prüfungsamt.
