...
6. Bitte tragen Sie ggf. zuerst Ihre Matrikelnummer und Ihren Namen in die Klausur ein (sofern Sie nicht ein personenbezogenes Prüfungsexemlar mit Ihrem Namen bekommen haben).
7. Bitte kreuzen Sie (in Papierklausuren) *ordentlich* an, da sonst der Korrekteur oder der Scanner u.U. Ihr Kreuz falsch liest, s. @fig-kreuzen und @fig-kreuzen2.
...
2. Halten Sie Ihren (gültigen) Studentenausweis bereit.
3. Drehen Sie die Bögen der Prüfung erst auf Geheiß um.
...
5. Auf dem Tisch jedes Prüflings dürfen kein Taschen, Mäppchen oder Ähnliches liegen.
6. Beachten Sie die ausgewiesenen Hilfsmittel.
7. Kopfbedeckungen sind nicht zulässig.
...
9. Toilettengänge sind nur einzeln erlaubt.
10. Denken Sie daran, Ihren Namen und Ihre Matrikelnummer auf den Prüfungsbogen einzutragen.
11. Bleiben Sie sitzen, falls Sie fertig sind, solange bis die Prüfungszeit vorbei ist.
