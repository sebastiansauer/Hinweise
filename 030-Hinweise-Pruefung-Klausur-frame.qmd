...
3. In der Prüfungsordnung der HS Ansbach ist geregelt, dass *50%* der maximal erreichbaren Punkt benötigt sind zum *Bestehen* (*absolute Bestehensgrenze* s. § 8c APO HS Ansbach); es sei denn, die relative Bestehensgrenze kommt zum Zug.
...
3. Drehen Sie die Bögen der Prüfung erst auf Kommando um.
...
5. Auf dem Tisch bei jedem Prüfling dürfen kein Taschen, Mäppchen oder Ähnliches liegen.
