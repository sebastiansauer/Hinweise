...
Pro Präsentation sind ca. 45 Minuten angesetzt. Diese Zeit setzt sich zusammen aus Vortrag plus Diskussion plus Feedback plus Pause bzw. Umbau für die nächste Präsentation.
...
:::callout-note
Die Zufallsreihenfolge aller angemeldeten Prüflinge bestimmt der Dozent durch die R-Funktion `sample`, wobei als Startwert das Datum des (ersten) Prüfungstags herangezogen wird^[Im Format ISO 8601, z.B. "20240126"]. $\square$
:::
...
### Zur Durchführung Ihrer Präsentation
