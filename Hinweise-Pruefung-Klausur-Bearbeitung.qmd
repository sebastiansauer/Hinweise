...
d_joint <-
  ...
  dplyr::mutate(csv_html = glue::glue("<a href={CSV}>CSV-Datei</a>")) |> 
  dplyr::mutate(doc_html = glue::glue("<a href={Doc}>Dokumentation</a>"))
```
...
#| label: tbl-pruef-csv
d_joint |> 
  dplyr::select(id, Shortname, CSV = csv_html, Doc = doc_html) |> 
