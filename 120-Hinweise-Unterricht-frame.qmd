...
- Bitte beachten Sie, dass die *meisten Module nur ein Mal pro Jahr angeboten* werden (also entweder im Sommer- oder im Wintersemester, aber nicht beides. Eine Ausnahme ist das Bachelormodul, das jedes Semester angeboten wird).
- Wenn Sie *krank* oder verhindert sind und daher *nicht am Unterricht teilnehmen* können, sind Sie *selber verantwortlich, den Stoff nachzuholen*. Nutzen Sie die eingestellten Lehrmaterialien und fragen Sie Kommilitonis um Hilfe. Der Dozent stellt Lehrmaterialien so zur Verfügung, dass auch ein komplettes Selbststudium möglich ist.

## Präsenzunterricht

- Beachten Sie aktuell geltenden *Hygienevorschriften*.
- Bitte *meiden* Sie datenhungrige Applikationen wie das *Streamen* von Filmen – Sie behindern den Unterricht durch Verstopfen der Datenautobahn.
...
- Während einer Aufnahme dürfen aus Datienschutzgründen keine Wortbeiträge zu hören sein, die Personen identifizieren. 
...
- Die *Video-Aufnahmen werden u.U. im Internet (z.B. YouTube) frei veröffentlicht*. Solche offenen Beiträge im Internet können u.U. in Zukunft nicht kontrolliert werden, insbesondere können sie unkontrolliert verbreitet und kommentiert werden. 
...
- Anonyme Teilnahmen im Online-Unterricht sind nicht erlaubt und u.U. technisch nicht möglich.
- Der Chat-Verlauf ist für alle Teilnehmis sichtbar. Bitte beachten Sie, dass der Chat-Verlauf auch aufgezeichnet werden kann.
...
- [Bereiten Sie bitte R und seine Freunden vor ](https://data-se.netlify.app/2021/11/30/installation-von-r-und-seiner-freunde/) vor der ersten Unterrichtsstunde. Sie können entweder R auf Ihrem Computer installieren oder den Cloud-Dienst [RStudio Cloud](https://posit.cloud/) nutzen. 
- Bitte beachten Sie die Installationshinweise für Software im Skript und stellen Sie sicher, dass die Software vor *Beginn des ersten Termins einsatzbereit* ist.



## Ich check den Stoff nicht. Was soll ich tun?
...
- *Posten* Sie das Problem im Forum oder einem Online-Forum. Bei Problemen mit R: Stellen Sie Ihrem Post ein [Erbie](https://data-se.netlify.app/2022/01/31/erbie-einfache-reproduzierbare-beispiele-ihres-problems-mit-r-syntax/) bei.
...
- Aus Sicherheitsgründen kann eine Zoom-Konferenz auf Ihre "offizielle" E-Mail-Adresse (der Hochschule) begrenzt sein. Mit einer anderen, potenziell anonymen E-Mail-Adresse, können Sie also u.U. nicht teilnehmen. Anders gesagt: Die Identität aller Teilnehmerinnen und Teilnehmer ist offengelegt.
