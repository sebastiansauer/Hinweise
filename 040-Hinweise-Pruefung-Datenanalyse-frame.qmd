...
1. Richtlinien einer *Wortzahl* gibt es nicht. Entscheidend ist, dass relevante Analysen durchgeführt und beschrieben wurden. Schreiben Sie so knapp wie möglich und so ausführlich wie nötig.
...
4. Achten Sie auf *Übersichtlichkeit* und ansprechende Gestaltung. Eine Gliederung und nummerierte Abschnitte tragen zur Übersichtlichkeit bei.

5. Beachten Sie die *Grundlagen des wissenschaftlichen Schreibens* etwa zu Zitieren und Referenzieren. So sollten etwa Diagramme für sich genommen (in Grundzügen) verständlich sein.
...
6. Legen Sie Wert auf die *Reproduzierbarkeit* der Analyse.

7. *Prüfen Sie* zu Beginn der Prüfungszeit, ob Sie auf die *Daten zugreifen* können und diese einlesen können. Melden Sie sich bei Problemen vor Beginn der Prüfungszeit beim Dozenten.
...
7. Die *R-Syntax* soll im Hauptteil des Berichts dokumentiert werden. R-Output soll im Hauptteil berichtet werden, kann aber ggf. gekürzt wiedergegeben werden.
...
1. Einzureichen sind folgende Dateien:
  ...
  a. der *Bericht* in menschenlesbarer Form (erstellt mit z.B. Quarto oder Word; s. Formatierungshinweise)
...
3. *Benennen* Sie Ihre *Dateien* nach folgendem Schema: <Nachname>-<Vorname>-<Matrikelnummer>.<Dateiendung>, z.B.
`mustermann-max-01234567.R`.
