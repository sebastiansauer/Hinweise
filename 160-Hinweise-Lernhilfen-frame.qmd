...
## Vorlagen und Beispiele für Prüfungsaufgaben

### Vorlagen für typische statistische Analysen
...
Nutzen Sie auch einen KI-Bot, um sich Übungsaufgaben erstellen zu lassen. 
Dazu können Sie dem Bot den Stoff nennen oder das Skript einlesen lassen,
um auf dieser Basis passende Aufgaben zu erhalten.
...
- *Übungen*: Bearbeiten Sie alle Übungsaufgaben gewissenhaft. Versuchen Sie selber erst, die Aufgabe zu lösen, bevor Sie die Musterlösung anscnhauen.
...
- *Sync*: Das Lernen mit der Unterricht synchronisieren, nicht erst kurz vor der Prüfung anfangen.
...
Manche Module können in Präsenz und Online angeboten (bzw. besucht) werden.
...
Hingegen ist bei einer Online-Teilnahme nur eingeschränkt aktive Mitarbeit möglich.
...
Sie können ein Beratungsgespräch bei mir wahrnehmen, z.B. im Zuge Ihrer Vorbereitung der Abschlussarbeit.
Ziel des Beratungsgespräches ist es, Fragen zu den schriftlichen Hinweisen zu klären (oder etwaige fehlende Informationen zu ergänzen).
Darüber hinaus sind immer wieder Fragen der Forschungsmethodik (wie Versuchsplanung und Datenanalyse) Gesprächsthema.
Es soll also darum gehen, ihre konkreten Fragen soweit wie möglich zu beantworten.
Es ist nicht Ziel das Gesprächs, größere Teile Ihrer Qualifizierungsarbeit vom Prüfer bearbeiten zu lassen ;-)

Bitte bereiten Sie sich auf das Gespräch wie folgt vor:

- Lesen Sie die relevanten Teile des [Hinweisbuches](https://hinweisbuch.netlify.app/). Tipp: Nutzen Sie den Suchschlitz, um nach passenden Stichwörtern zu suchen.
- Recherchieren Sie in gängigen Fachbüchern oder bei einer KI zu Ihrer Frage. In den Kursbüchern der Autors - [Statistik1](https://sebastiansauer.github.io/statistik1/), [Start:Bayes](https://sebastiansauer.github.io/start-bayes/) und [Forschungsprojekt](https://sebastiansauer.github.io/fopra/) - finden Sie Anleitungen, die auf studentische Arbeiten zugeschnitten sind.
- Wenn Sie Fragen zur Auswertung haben: Bringen Sie Hypothesen mit zum Gespräch. Bitte klären Sie vorab die Skalenniveaus und die Operationalisierung Ihrer Hypothesen. Zentral ist, dass Sie jederzeit wissen, was die UV und was die AV einer Hypothese ist.


Tipps:

- Lesen Sie vorab die [FAQ](https://hinweisbuch.netlify.app/167-faq).
- Lesen Sie vorab die [häufigen Fehler in der Datenanalyse](https://hinweisbuch.netlify.app/180-beispiele-fehler-datenanalyse-frame).
- Lesen Sie vorab die [Hinweise zu Qualifizierungsarbeiten](https://hinweisbuch.netlify.app/100-hinweise-pruefung-thesis-frame).
