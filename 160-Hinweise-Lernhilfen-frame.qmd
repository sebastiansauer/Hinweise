...
- Lesen Sie vorab die [FAQ]().
- Lesen Sie vorab die [häufigen Fehler in der Datenanalyse](@tbl-typ-fehler-statistik zeigt häufige Fehler bei statistischen Auswertungen in studentischen Arbeiten.
...
: Typische Fehler in statistischen Auswertungen {#tbl-typ-fehler}
)
