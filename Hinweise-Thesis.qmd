...
1. Die Wahl des Themas beginnt mit Beginn des 6. Fachsemesters (SoSe: 15. März, WiSe: 1. Oktober).^[es kann aber auch z.B. das 7. Fachsemester sein]
2. Themen (und damit eine verbindliche Zusage meinerseits) vergebe ich bis spätestens Mitte des 6. Fachsemesters (SoSe: 15. Mai, WiSe: 15. November). Nach diesem Termin ist eine Anmeldung (bei mir) erst wieder im Folgesemester möglich (s. Abbildung).
3. Das Exposé muss bis Semesterende bei mir eingereicht sein (SoSe: 30. Juni, WiSe: 31. Dezember).
4. Sie bekommen gegen Ende des Prüfungszeitraums schriftliches Feedback zu Ihrem Exposé (SoSe: 31. Juli, WiSe: 31. Januar).
5. Die Bearbeitungszeit Ihrer Abschlussarbeit *beginnt* mit *Start* des 7. Fachsemesters (WiSe: 1. Oktober, SoSe: 15. März).
6. Die *Bearbeitungszeit* Ihrer Abschlussarbeit endet *drei Monate* nach Beginn (WiSe: 31. Dezember, SoSe: 15. Juni).
7. Ihr Gutachten und Ihre Note erhalten Sie bis zu Beginn des Folgesemester.
...
- Wenn Sie ein Formular an mich (oder Dritte, wie die Prüfungsabteilung) senden, nennen Sie bitte stets Ihren Namen im Dateinamen. Falsch: "Anmeldung-Thesis.pdf". Richtig: "Anmeldung-Thesis-Sauer-Sebastian-01234567.pdf".
