...
Mein Fokus liegt dabei bei Arbeiten mit quantitativer Methodikk.
...
flowchart TD
  ...
  C[Studie schreibt Exposé]
  D[Betreuer gibt Feedback]
  E[Studie meldet formal an]
  F[Los geht's!]
  A-->B-->C-->D-->E-->F
```
...
1. Lesen Sie sich als Erstes die Hinweise Ihres Gutachters durch: Welche Themen gibt er oder sie vor? Welche Rahmenbedingungen gibt es?
...
2. Sprechen Sie den Gutachter an, dass Sie das Thema bearbeiten wollen. Bringen Sie Ihre Fragen mit zu dem Gespräch? (Das Gespräch kann persönlich sein, via Zoom oder E-Mail stattfindetn.)
...
3.Jetzt schreiben Sie ein Exposé (und reichen es via Moodle ein).

4.Der Dozent gibt Ihnen schriftlich Feedback zu Ihrem Exposé.

5. Melden Sie zu Beginn des Semesters (in dem Sie Ihre Thesis schreiben wollen) Ihre Arbeit via Primuss an mit dem vom Prüfer bereitgestellten Formular (findet sich in Moodle auf der Seite des Bachelor-Seminars). Mit der Anmeldung wird das Thema der Arbeit fixiert.

5. Puh, jetzt heißt es für drei Monate: Lesen, Denken, Schreiben...
Jippie! Fast geschafft! Sie reichen Ihre Arbeit ein. 
Sie bekommen ein (schriftliches) Gutachten zu Ihrer Arbeit. Ein Kolloquium ist im Rahmen des Bachelorseminars vorgehesen.
