...
Ich betreue Themen aus aus der Psychologie (und angrenzender Wissenschaften), 
...
kann es sinnvoll sein, vor oder während der Promotion (intensiv) psychologische und wissenschaftsmethodische Fachliteratur zu lesen.

Kumulative Promotion hat auch den Vorteil, dass Sie von Ihrem Betreuer (z.B. mir) weniger abhängig sind: 
...
häufig empfiehlt sich eine Kombination aus theoretischer Arbeit (Literaturüberblick, wie bibliometrische Analyse oder systematisches Review) plus quantitativer Methode (Experimente und/oder Beobachtungsstudine).

Mit meinen Doktorandinnen und Doktoranden pflege ich einerseits regelmäßige Treffen zur Besprechung des aktuellen Stands sowie eine Einbindung in Gruppenformate wie z.B. Forschungskolloquien.
...
Je länger sich das Projekt Doktorarbeit hinzieht, desto größer wird die Gefahr, dass es zu keinem Abschluss kommt.
